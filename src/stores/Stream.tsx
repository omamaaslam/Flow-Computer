...
const SUPPORTED_COMPONENTS_BY_METHOD: Record<string, string[]> = {
  Constant: [],
  GERG88_1: ["HS", "SD", "RHOL", "CO2", "H2", "N2"],
  GERG88_2: ["HS", "SD", "RHOL", "CO2", "H2", "N2"],
  GERG88_3: ["HS", "SD", "RHOL", "CO2", "H2", "N2"],
  AGA8_GCM_1: ["HS", "RHOL", "N2", "SD", "CO2"],
  AGA8_GCM_2: ["HS", "RHOL", "N2", "SD", "CO2"],
  SGERG_H2: ["H2", "N2", "CO2", "CH4", "HE", "H2O"],
  AGA_NX19_H: ["H2","HS", "ROHL", "SD", "CO2", "N2"],
  AGA8_DC92: [
    "CH4",
    "N2",
    "CO2",
