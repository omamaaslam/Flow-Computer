...
// A simple, error-free UI component for the Volume Device Form.
const VolumeDeviceForm = () => {
      ...
      <div>
        ...
        {activeTab === "parameters" && (
          <div className="grid grid-cols-2 gap-x-6 gap-y-4">
            {/* K-Factor */}
            <div className="space-y-1">
              <label className="block text-xs font-medium text-gray-600">Min Volume</label>
              <input type="text" placeholder="Please set Min Volume" className="w-full border border-gray-300 rounded-md py-1.5 px-3 text-sm placeholder:text-gray-400 shadow-sm focus:ring-1 focus:ring-yellow-500 focus:border-yellow-500" />
            </div>

            {/* Meter Factor */}
            <div className="space-y-1">
              <label className="block text-xs font-medium text-gray-600">Max Volume</label>
              <input type="text" placeholder="Please set Max Volume" className="w-full border border-gray-300 rounded-md py-1.5 px-3 text-sm placeholder:text-gray-400 shadow-sm focus:ring-1 focus:ring-yellow-500 focus:border-yellow-500" />
            </div>
            </div>
        )}
      </div>
