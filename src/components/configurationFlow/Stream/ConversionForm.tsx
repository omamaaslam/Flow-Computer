      ...
      <div className="flex flex-col gap-4">
        ...
        {stream.showComponentTable && (
          <div className="border border-gray-200 rounded-md overflow-hidden shadow-sm">
            ...
            <div>
              {stream.componentsForActiveMethod.map((component: GasComponent) => {
                const Row = observer(() => {
                  
                  // --- START: CORRECTED FILTER LOGIC ---
                  const relevantDevices = availableDevices.filter((device) => {
                    // The 'return' keyword is essential here!
                    // We match the device name against the component's display name.
                    return device.name.toLowerCase() === component.key.toLowerCase();
                  });
