// src/components/configurationFlow/IoCardSvg.tsx

// Step 1: Update the props interface to match the backend IDs
interface IoCardSvgProps {
  onMod1Click: () => void;
  mod1StatusColor: string;
  onDi2Click: () => void;
  ...
  onHi1Click: () => void;
  hi1StatusColor: string;
  onTi1Click: () => void;
  ti1StatusColor: string;
  onAo2Click: () => void;
...
const IoCardSvg = (props: IoCardSvgProps) => {
  ...
  return (
    ...
    >
      {/* Static Background Elements: Connector, Wires, Pins - NOW INCLUDED */}
      <g>
        <rect x="230.327" y="4.69772" width="122.75" height="658.265" rx="18.8847" fill="white" stroke="#211D1D" strokeWidth="5.39562" />
        <path d="M317.079 120.412L316.099 118.617C314.208 115.15 310.575 112.993 306.626 112.993H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M275.263 136.599L271.216 129.18H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M317.079 56.6305L316.099 54.8353C314.208 51.3685 310.575 49.2115 306.626 49.2115H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M275.263 72.8175L271.216 65.3985H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M317.079 182.461L316.099 180.666C314.208 177.199 310.575 175.042 306.626 175.042H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M275.263 198.648L271.216 191.229H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M267.843 150.087L268.822 148.292C270.713 144.825 274.347 142.668 278.296 142.668H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M309.659 166.274L313.706 158.855H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M267.843 89.0043L268.822 87.2092C270.713 83.7424 274.347 81.5853 278.296 81.5853H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M309.659 105.191L313.706 97.772H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M267.843 213.103L268.822 211.308C270.713 207.841 274.347 205.684 278.296 205.684H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M309.659 229.29L313.706 221.871H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M267.843 275.153L268.822 273.358C270.713 269.891 274.347 267.734 278.296 267.734H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M309.659 291.34L313.706 283.921H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M267.843 337.203L268.822 335.407C270.713 331.941 274.347 329.784 278.296 329.784H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M309.659 353.389L313.706 345.97H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M267.843 399.252L268.822 397.457C270.713 393.99 274.347 391.833 278.296 391.833H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M309.659 415.439L313.706 408.02H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M267.843 461.301L268.822 459.506C270.713 456.039 274.347 453.882 278.296 453.882H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M309.659 477.488L313.706 470.069H496.482" stroke="black" strokeWidth="4.04671" />
        <path d="M267.845 616.425L268.824 614.63C270.715 611.163 274.349 609.006 278.298 609.006H496.484" stroke="black" strokeWidth="4.04671" />
        <path d="M309.661 632.612L313.708 625.193H496.484" stroke="black" strokeWidth="4.04671" />
        <path d="M267.845 523.351L268.824 521.556C270.715 518.089 274.349 515.932 278.298 515.932H496.484" stroke="black" strokeWidth="4.04671" />
        <path d="M309.661 539.538L313.708 532.119H496.484" stroke="black" strokeWidth="4.04671" />
        <path d="M309.661 570.563L313.708 563.144H496.484" stroke="black" strokeWidth="4.04671" />
        <path d="M267.844 553.701L272.782 546.957H495.809" stroke="black" strokeWidth="4.04671" />
        <path d="M317.079 244.128L316.099 242.333C314.208 238.866 310.575 236.709 306.626 236.709H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M275.263 260.315L271.216 252.896H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M317.079 306.178L316.099 304.383C314.208 300.916 310.575 298.759 306.626 298.759H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M275.263 322.365L271.216 314.946H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M317.079 368.227L316.099 366.432C314.208 362.966 310.575 360.808 306.626 360.808H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M275.263 384.414L271.216 376.995H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M317.079 430.277L316.099 428.482C314.208 425.015 310.575 422.858 306.626 422.858H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M275.263 446.464L271.216 439.045H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M317.079 493.676L316.099 491.88C314.208 488.414 310.575 486.257 306.626 486.257H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M275.263 508.896L271.216 501.477H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M317.079 585.401L316.099 583.606C314.208 580.139 310.575 577.982 306.626 577.982H88.4395" stroke="black" strokeWidth="4.04671" />
        <path d="M275.263 601.588L271.216 594.169H88.4395" stroke="black" strokeWidth="4.04671" />
        <g>
          <circle cx="271.891" cy="64.0494" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="64.0494" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="95.0742" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="95.0742" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="126.099" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="126.099" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="157.124" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="157.124" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="188.149" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="188.149" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="219.173" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="219.173" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="250.198" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="250.198" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="281.223" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="281.223" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="312.248" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="312.248" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="343.272" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="343.272" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="374.297" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="374.297" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="405.322" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="405.322" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="436.347" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="436.347" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="467.372" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="467.372" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="498.396" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="498.396" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="529.421" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="529.421" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="560.446" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="560.446" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="591.471" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="591.471" r="10.7912" fill="#A2A1A1" /><circle cx="271.891" cy="622.496" r="10.7912" fill="#A2A1A1" /><circle cx="315.055" cy="622.496" r="10.7912" fill="#A2A1A1" />
        </g>
      </g>
